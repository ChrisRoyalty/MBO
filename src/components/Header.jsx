...
const Header = () => {
  ...
  const handleNav = () => {
    toggleNav === "hidden" ? setToggleNav("block") : setToggleNav("hidden");
  };
  return (
      ...
      <div className="w-[90%] h-[10vh] bg-[#043D12] px-[50px] flex justify-between items-center rounded-[48px] shadow-lg">
        ...
        >
          <nav className="flex max-md:flex-col max-md:w-[90%] max-md:m-auto md:gap-8 gap-4">
            <Link
              to="/"
              className="text-[20px] hover:text-[21px] bg-[#043D12] w-full  max-md:border-[1px] max-md:border-white max-md:rounded-[39px] w-fit h-fit max-md:px-8 max-md:py-2 max-md:hover:text-[21px]"
            >
              Home
            </Link>
            <Link
          ...
          <div className="login flex max-md:flex-col max-md:w-[90%] max-md:m-auto">
            <Link
              to="/login"
              className="text-[20px] border-[1px] border-white rounded-[39px] w-fit h-fit px-8 py-2 hover:text-[21px] bg-[#043D12] w-full"
            >
              Log In
            </Link>
          </div>
