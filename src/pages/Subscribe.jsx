...
const Subscribe = () => {
  return (
    <div className="bg-[#043D12] w-full h-fit max-lg:py-16 lg:h-screen flex flex-col justify-center items-center">
      <div className="w-[90%] md:w-[70%] h-fit text-center flex flex-col gap-8">
        <h1 className="text-[#B4B3B3] lg:text-[35px] text-[20px] w-[90%] md:w-[60%] mx-auto">
          Stay Connected, Stay Promoted: <br className="max-lg:hidden" /> Your
          All-in-One Plan
        </h1>
        <div className="details w-full bg-white px-10 py-12 md:p-10 grid lg:grid-cols-2 grid-cols-1 bg-[#FFFDF2]">
          <div className="amount w-full h-fit max-lg:flex flex-col items-center lg:pt-24">
            <div className="">
              <div className="w-fit leading-[20px] max-lg:flex">
                <h1 className="lg:text-[64px] text-[54px] text-[#043D12] flex items-center w-fit">
                  <TbCurrencyNaira />
                  15,000
                </h1>
          ...
          <div className="w-full benefit flex flex-col gap-4 max-lg:items-center max-lg:justify-center max-md:mt-8">
            <div className="w-fit flex flex-col gap-4">
              <ul className="flex items-center gap-4">
                ...
                <li className="md:text-[24px] text-[16px] text-[#676767]">
              ...
              <div className="shadow-lg mt-8 register px-6 md:px-14 md:py-8 py-2 bg-[#043D12] rounded-[9px] text-[#FFFDF2] flex flex-col gap-2">
        ...
        <h1 className="text-[#B4B3B3] lg:text-[24px] text-[16px] w-[90%] md:w-[60%] mx-auto">
